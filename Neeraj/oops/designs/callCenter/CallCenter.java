    ...
    public static void main(String[] args) {
        ...
        Thread t1 = new Thread(() -> {
            for (int i = 0; i < 10; i++) {
                ...
                System.out.println("Adding a callCenter.Call");
                try {
                    Thread.sleep(1000);
...
class CallHandler{
    ...
    public void handleCall(Call call){
        ...
        if (call.type.equals(EmpType.Operator)){
            ...
            throw new RuntimeException("The callCenter.Call type is invalid");
        }
    }
...
class Operator extends Employee{
    ...
    public void receiveCall(Call call){
        System.out.println("callCenter.Operator: Receiving callCenter.Call.");
...
//            When even then escalate call.
    ...
    @Override
    void getNextCall(){
        System.out.println("callCenter.Operator: GetNext callCenter.Call.");
        Call call = handler.getNextCall(EmpType.Operator);
        if(call == null){
            System.out.println("callCenter.Operator: I am ideal.");
        }else{
            receiveCall(call);
        }
    }
    ...
    void escalateCall(Call call){
        ...
        System.out.println("callCenter.Operator: Escalating callCenter.Call.");
...
class Manager extends Employee{
    ...
    @Override
    public void receiveCall(Call call){
        System.out.println("callCenter.Manager: Receiving callCenter.Call.");
        if (random.nextInt(10) % 2 == 0){
//            When even then escalate call.
            escalateCall(call);
        }else{
    ...
    public void getNextCall(){
        System.out.println("callCenter.Manager: GetNext callCenter.Call.");
        Call call = handler.getNextCall(EmpType.Manager);
        if(call == null){
            System.out.println("callCenter.Manager: I am ideal.");
        }else{
            receiveCall(call);
        }
    }
    ...
    public void escalateCall(Call call){
        ...
        call.status = CallStatus.Received;
        System.out.println("callCenter.Manager: Escalating callCenter.Call.");
        handler.handleCall(call);
    }
}
...
class Director extends Employee{
    ...
    @Override
    public void receiveCall(Call call){
        System.out.println("callCenter.Director: Receiving callCenter.Call.");
        if (random.nextInt(10) % 2 == 0){
//            When even then escalate call.
            escalateCall(call);
        }else{
    ...
    @Override
    public void getNextCall(){
        System.out.println("callCenter.Director: GetNext callCenter.Call.");
        Call call = handler.getNextCall(EmpType.Director);
        if(call == null){
            System.out.println("callCenter.Director: I am ideal.");
        }else{
            receiveCall(call);
        }
    }
    ...
    @Override
    public void escalateCall(Call call){
        System.out.println("callCenter.Director: I can handle all callCenter.Call.");
    }
}
